...
class DeblurDataset(Dataset):
    def __init__(self, image_dir, transform=None, is_test=False):
        ...
        if self.is_test:
            ...
            self.map = ReadJson("dataset/rain_map_train.json")
    ...
    def __getitem__(self, idx):
        ...
        image = Image.open(os.path.join(self.image_dir, 'blur_rain', self.map[self.image_list[idx]]))

        label = Image.open(os.path.join(self.image_dir, 'sharp', self.image_list[idx]))
        # label = Image.open(os.path.join(self.image_dir, 'sharp_rain', self.map[self.image_list[idx]]))
